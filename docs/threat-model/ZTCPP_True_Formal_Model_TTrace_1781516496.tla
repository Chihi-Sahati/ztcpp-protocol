...
trace == 
    ...
    ([network_partition |-> FALSE,byzantine_ac |-> FALSE,state |-> (a1 :> "LISTEN"),sat_registry |-> {[exp |-> 1, agent |-> a1, active |-> TRUE]},clock |-> 0,highest_nonce |-> (a1 :> 0),network |-> {},byzantine_server |-> FALSE]),
    ([network_partition |-> FALSE,byzantine_ac |-> FALSE,state |-> (a1 :> "LISTEN"),sat_registry |-> {[exp |-> 1, agent |-> a1, active |-> TRUE]},clock |-> 0,highest_nonce |-> (a1 :> 0),network |-> {[agent |-> a1, nonce |-> 1, type |-> "KNK"]},byzantine_server |-> FALSE]),
    ([network_partition |-> FALSE,byzantine_ac |-> FALSE,state |-> (a1 :> "PARSE_SIG"),sat_registry |-> {[exp |-> 1, agent |-> a1, active |-> TRUE]},clock |-> 0,highest_nonce |-> (a1 :> 0),network |-> {[agent |-> a1, nonce |-> 1, type |-> "KNK"]},byzantine_server |-> FALSE]),
    ([network_partition |-> FALSE,byzantine_ac |-> FALSE,state |-> (a1 :> "VERIFY_SAT"),sat_registry |-> {[exp |-> 1, agent |-> a1, active |-> TRUE]},clock |-> 0,highest_nonce |-> (a1 :> 1),network |-> {[agent |-> a1, nonce |-> 1, type |-> "KNK"]},byzantine_server |-> FALSE]),
    ([network_partition |-> FALSE,byzantine_ac |-> FALSE,state |-> (a1 :> "EVALUATE_MAMA"),sat_registry |-> {[exp |-> 1, agent |-> a1, active |-> TRUE]},clock |-> 0,highest_nonce |-> (a1 :> 1),network |-> {[agent |-> a1, nonce |-> 1, type |-> "KNK"]},byzantine_server |-> FALSE]),
    ([network_partition |-> FALSE,byzantine_ac |-> FALSE,state |-> (a1 :> "EVALUATE_MAMA"),sat_registry |-> {[exp |-> 1, agent |-> a1, active |-> TRUE]},clock |-> 1,highest_nonce |-> (a1 :> 1),network |-> {[agent |-> a1, nonce |-> 1, type |-> "KNK"]},byzantine_server |-> FALSE])
    >>
----
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Jun 15 11:41:37 EET 2026